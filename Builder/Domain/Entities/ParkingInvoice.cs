...
namespace Domain.Entities
{
    ...
    {
        private const int CylindersMaximunMotorcycle = 500;
        public double SurchangeValue { get; set; }
        public double Subtotal { get; set;}
        public double TotalValue { get; set; }
        [ForeignKey("CellVehicleId")] private int CellVehicleId { get; set; }
        ...
        {
            var numberHours = CellVehicle!.GetHoursBetwenDates();
            var numberDays = CellVehicle.GetDaysBetwenDates();
            if (IsChargePerHour())
        ...
        private bool HasSuerchange()
        {
            if (CellVehicle?.Vehicle != null && CellVehicle != null && CellVehicle.Vehicle.IsMotorcycle())
                return CellVehicle.Vehicle.Cylinders > CylindersMaximunMotorcycle;
            else
                return false;
        }
